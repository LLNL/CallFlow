...
export default {
  	...
  	data: () => ({
		...
		runtimeHeaders: [
			...
			{ text: 'Min. Inclusive runtime (\u03BCs)', value: 'min_inclusive_runtime' },
			{ text: 'Max. Inclusive runtime (\u03BCs)', value: 'max_inclusive_runtime', sortable: true },
			{ text: 'Min. Exclusive runtime (\u03BCs)', value: 'min_exclusive_runtime' },
			{ text: 'Max. Exclusive runtime (\u03BCs)', value: 'max_exclusive_runtime' },
		],
		runtime: [],
		expanded: [],
        singleExpand: false,
		moduleHeaders: [
			...
			{ text: 'Inclusive runtime (\u03BCs)', value: 'inclusive_runtime', sortable: true },
