...
const hotMiddleware = require('./hotMiddleware.js');

const app = express();
const server = http.createServer(app);

if (!isDev) {
    app.use(hotMiddleware.hotMiddleware);    
}
...
function sankeySplitNodeCallBack(data) {
    ...
    server.listen(Config.port, Config.host, () => {
        console.log('Sever started, listening', Config.host, Config.port);
    });
}
